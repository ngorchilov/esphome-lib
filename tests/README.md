...
The device-family cases cover CB2S/T1-M CT meters and CBU/T1-U 4PM strips, including standalone
defaults, include vars, channel names, UART overrides and custom relay IDs. Assertions preserve
